...
namespace CosmosChangeLogSample.Data.Extensions
{
  using System;
  ...
  using CosmosChangeLogSample.Data.MappingProfiles;
  ...
  public static class ServicesExtensions
  {
      ...
      string databaseName)
    {
      ...
      services.AddScoped<IProductChangeNoteRepository, ProductChangeNoteRepository>();

      services.AddAutoMapper(typeof(OrderProductRelationProfile).Assembly);
