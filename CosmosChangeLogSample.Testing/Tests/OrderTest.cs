...
namespace CosmosChangeLogSample.Testing.Tests
{
  using System;
  using System.Linq;
  ...
  using CosmosChangeLogSample.Data.Extensions;
  using CosmosChangeLogSample.Data.Repositories;
  using CosmosChangeLogSample.Testing.Helpers;
  ...
  public class OrderTest
  {
    ...
    private IProductChangeNoteRepository _productChangeNoteRepository;
    ...
    {
      var provider = new ServiceCollection().AddDataAccess("https://localhost:8081/", "C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw==", "cclsdb")
                                            .BuildServiceProvider();

      _disposable = provider;

      _productChangeNoteRepository = provider.GetRequiredService<IProductChangeNoteRepository>();
